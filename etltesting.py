...
#    Apr 20, 2019 01:15:39 PM IST  platform: Windows NT
...
def vp_start_gui():
    ...
    root = tk.Tk()
    top = ETL (root)
#     etltesting_support.init(root, top)
    root.mainloop()

w = None
# def create_ETL(root, *args, **kwargs):
#     '''Starting point when module is imported by another program.'''
#     global w, w_win, rt
#     rt = root
#     w = tk.Toplevel (root)
#     top = ETL (w)
# #     etltesting_support.init(w, top, *args, **kwargs)
#     return (w, top)
...
class ETL:
    ...
    def connectdatabase(self):
        print('etltesting_support.connectdatabase')
        global connection
        global cursor1
        global cursor2
        global cursor3
        ...
        c=cursor.execute('select * from FlightsBooking')
        print(c.fetchall())
        
    def fetchTableDetails(self):
        print('etltesting_support.fetchTableDetails')
...
#         master.selected.get(idx) for idx in master.selected.curselection()
    ...
    def testselected(self):
        self.selectedcolumns=[self.columsList.get(i) for i in self.columsList.curselection()]
...
#         sorcetabledata=cursor3.execute(self.sqlsource)
#         targettabledata=cursor4.execute(self.sqltarget)
#         sorcetabledatadf=pd.DataFrame(sorcetabledata.fetchall())
#         targettabledatadf=pd.DataFrame(targettabledata.fetchall())
...
#         print(sorcetabledatadf)  
#         print(targettabledatadf)
        if(x.equals(y)):
            print(True)
    ...
    def __init__(self, top=None):
        ...
        self.ClauseFrame.place(relx=0.492, rely=0.056, relheight=0.396
                , relwidth=0.207)
        ...
        self.Clause.place(relx=0.075, rely=0.842, height=21, width=41)
        ...
        self.clause.place(relx=0.377, rely=0.842, relheight=0.091
                , relwidth=0.479)
        self.clause.configure(foreground="#000000")
        ...
        self.Columns.place(relx=0.075, rely=0.105, height=21, width=54)
        ...
        self.columsList.place(relx=0.377, rely=0.105, relheight=0.519
                , relwidth=0.468)
        ...
        self.SelectColumns.place(relx=0.377, rely=0.702, height=24, width=93)
        ...
        self.SelectColumns.configure(command=self.show,pady="0")
